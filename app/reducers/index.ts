...
import  * as fromAppFirebaseReducer from './app-firebase.reducer';
...
export interface AppState {
  ...
  appFirebase: fromAppFirebaseReducer.AppFirebaseState;
  todo: fromTodo.TodoState;
}

// export * from './collection';
export * from './app-firebase.reducer';
 ...
 */
export default compose(localStorageSync(['todo'], true), storeFreeze, storeLogger(), combineReducers)({
  // These property names have to match those in the AppState interface.
  appFirebase: fromAppFirebaseReducer.appFirebaseReducer,
  todo: todoReducer
});
